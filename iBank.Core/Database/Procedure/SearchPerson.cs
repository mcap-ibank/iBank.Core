...
namespace iBank.Core.Database
{
    public class SearchPerson : INotifyPropertyChanged, IPersonData, IPersonPassportData, IPersonCommentData, IPersonBankData
    {
        ...
        public bool IsPassportInvalid => !CommonUtils.PassportIsValid(DateTime.ParseExact(BirthDate, "dd.MM.yyyy", CultureInfo.InvariantCulture), DateTime.ParseExact(PassportIssueDate, "dd.MM.yyyy", CultureInfo.InvariantCulture));
