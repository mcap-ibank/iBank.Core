            ...
            using (var worksheet = workbook.Worksheets.First())
            {
                for (int i = 4; ; i++)
                {
                    ...
                    yield return new ExcelPerson
                    {
                        ...
                        BirthDate = CommonUtils.GetDateTime(worksheet.Cells[i, 05].Value.ToString().Trim()),
                        ...
                        PassportIssueDate = CommonUtils.GetDateTime(worksheet.Cells[i, 09].Value.ToString().Trim()),
            ...
            using (var reader = ExcelReaderFactory.CreateReader(new MemoryStream(data)))
            {
                ...
                while(reader.Read() && !reader.IsDBNull(0) && !reader.IsDBNull(1))
                {
                    yield return new ExcelPerson
                    {
                        ...
                        BirthDate = CommonUtils.GetDateTime(reader.GetValue(04).ToString().Trim()),
                        ...
                        PassportIssueDate = CommonUtils.GetDateTime(reader.GetValue(08).ToString().Trim()),
